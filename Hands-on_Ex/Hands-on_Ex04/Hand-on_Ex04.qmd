...
1.  3A,3B,3D tend to follow a normal distribution

2.  lower bond of 3A is slightly lower compare to students in 3B, but at the higher bond 3A students perform much better compare to 3B students.

3.  3B students tend to be perform similarly well.
:::
