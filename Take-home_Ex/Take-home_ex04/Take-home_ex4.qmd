...
pacman::p_load(tidyverse,ggridges,ggrepel,ggthemes,ggstatsplot,ggsignif,
               ...
               gganimate,ggiraph,magick,highcharter,knitr,naniar,DT,imputeTS,ggHoriPlot,stars,terra,gstat)
```
...
## 6.1Does Singapore's Weather Change Across Different Years Shows Statistical Significant?
...
## 6.2 Can We Clearly Identify the 'Dry' and 'Wet' Month?
